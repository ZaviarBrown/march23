...
import allQuotes from "./quotes/index.js";
    ...
    start() {
        document.getElementById("hello").addEventListener("click", () => {
            ...
            if (index === 1) {
                ...
                messageContainer.innerText = allQuotes.mr["hello"];
            } else {
                // messageContainer.innerText = mrsPotatoHeadQuotes["hello"];
                messageContainer.innerText = allQuotes.mrs["hello"];
            }
        });
        ...
        document.getElementById("bye").addEventListener("click", () => {
            ...
            if (index === 1) {
                ...
                messageContainer.innerText = allQuotes.mr["bye"];
            } else {
                // messageContainer.innerText = mrsPotatoHeadQuotes["bye"];
                messageContainer.innerText = allQuotes.mrs["bye"];
            }
        });
