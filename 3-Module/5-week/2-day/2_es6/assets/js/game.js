...
import quoteCity from "./quotes/index.js";
    ...
    start() {
        document.getElementById("hello").addEventListener("click", () => {
            ...
            if (index === 1) {
                ...
                messageContainer.innerText = quoteCity.mr["hello"];
            } else {
                messageContainer.innerText = quoteCity.mrs["hello"];
            }
        });
        ...
        document.getElementById("bye").addEventListener("click", () => {
            ...
            const messageContainer = document.getElementById("message");
            if (index === 1) {
                messageContainer.innerText = quoteCity.mr["bye"];
            } else {
                messageContainer.innerText = quoteCity.mrs["bye"];
            }
        });
