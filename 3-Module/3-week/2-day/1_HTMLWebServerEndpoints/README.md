...
- Create a new user
  - `POST /users`
  <!-- - `GET /users/new` Get new user form -->
- Log In
  - `POST /login`
  - `POST /session`
  <!-- - `POST /session` API Web Servers, Soon! -->
- Log Out
  - `POST /logout`
  - `POST /session/delete`
  <!-- - `DELETE /session` API Web Servers, Soon! -->
...
- Delete a like for a post
  ...
  <!-- - `POST /posts/:postId/unlike` Weird option -->
  <!-- - `POST /like/:likeId/delete` Another weird option -->
