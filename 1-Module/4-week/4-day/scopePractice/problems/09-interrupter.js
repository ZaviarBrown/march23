...
const interrupter = (word) => {
    return (stringToBeInterrupted) => {
        const strArr = stringToBeInterrupted.split(" ");
        return strArr.join(" " + word + " ");
    };
};

// const interrupter = (word) => (stringToBeInterrupted) =>
//     stringToBeInterrupted.split(" ").join(" " + word + " ");
