...
testTenTimes(popTest, 1000000, true);
...
testTenTimes(mapTest, 1000000, true);
...
testTenTimes(filterTest, 1000000, true);
...
testTenTimes(reduceTest, 1000000, true);
...
testTenTimes(everyTest, 1000000, true);
