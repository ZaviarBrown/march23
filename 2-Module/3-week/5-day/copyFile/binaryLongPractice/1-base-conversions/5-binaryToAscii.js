...
console.log(
    binaryToAscii("011000010110001001100011"),
    binaryToAscii("011000010110001001100011") === "abc"
        ? "Passing!"
        : "You idiot"
);
// 'abc'
...
console.log(
    binaryToAscii("010000010100001001000011"),
    binaryToAscii("010000010100001001000011") === "ABC"
        ? "Passing!"
        : "You idiot"
);
// 'ABC'
